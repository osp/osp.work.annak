...
site, façon "nuage de tags". Les nouveaux usages du Web invitent à repenser la
manière classique d'indexer les contenus du livre imprimé, pour envisager de
mettre en exergue les sources mineures habituellement non-visibles. Nous
envisageons de mettre en place:
...
Cette expérimentation se propose d'observer l'évolution du style littéraire
de la période Helen Ferguson (HF), avant 1940 avec la période Anna Kavan (AK)
après 1940.
...
- et d'autre part *Who Are You ?*, 1963 ("nouveau roman") & *Ice*, 1967
...
Sur chacune de ces deux œuvres avons expérimenté avec:
...
Sources d'inspiration, de variations, de plagiats, de remix, etc. comment l'œuvre
...
-   Remix de remix (à l'aide d'un script python basé sur les chaines de Markov)
    ...
    1963 et *La prisonnière des Sargasses* de Jean Rhys 1966). Nous souhaitons «
...
leur parcours éditorial multiple (éditeurs, ré-éditions, traductions, etc).
Chaque livre de la collection, ayant fait l'objet d'une expérimentation sur le
site, pourrait être tagué et pointer vers les résultats de cette expérimentation,
créant ainsi un nouveau mode d'indexation.


### Les survenants

Si la ecture d'une oeuvre nous engage à la replacer dans un réseau de
...
- les éditions HYX, maison d'édition associative à Orléans, qui développe une
...
- Résidences d'écriture croisée (*data*, textes et code) : intégration des
  ...
  création en ligne – Catherine Lenoble & &lt;stdin&gt;. Lieux envisagés : La
