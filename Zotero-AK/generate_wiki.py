# Un script de base pour generer du code source wiki en utilisant le moteur de
# templates de Django
...
t = loader.get_template('wiki.md')

for book in book_list:
    c = Context({
        'book': book.asdict()
    })
    f = codecs.open(os.path.join(PROJECT_DIR, 'wiki', u'%s.md' % book[0]), "w", encoding="utf-8")
    f.write(t.render(c))
    f.close()
